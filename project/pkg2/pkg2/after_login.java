...
public class after_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/pkg2/pkg2/icons8_database_view_95px.png"))); // NOI18N
        ...
        jButton6.setBackground(new java.awt.Color(186, 79, 84));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/pkg2/pkg2/icons8_update_file_95px.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         setVisible(false); //you can't see me!
         dispose();
         borrow ob=new borrow(this.names);
         ob.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         name=this.names.replaceAll("\\s+", "");
         
         user_show ob = null;
        
        try {
            
            ob = new user_show(name);

        } catch (ClassNotFoundException ex) {
            Logger.getLogger(after_login.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
         setVisible(false); //you can't see me!
         dispose();
         update_user ob=new update_user(this.names);
         ob.setVisible(true);
